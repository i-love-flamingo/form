...
type mockConstructorTestingTNewFormDataEncoderFactory interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewFormDataEncoderFactory(t mockConstructorTestingTNewFormDataEncoderFactory) *FormDataEncoderFactory {
