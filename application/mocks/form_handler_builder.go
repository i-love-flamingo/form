...
type mockConstructorTestingTNewFormHandlerBuilder interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewFormHandlerBuilder(t mockConstructorTestingTNewFormHandlerBuilder) *FormHandlerBuilder {
