...
type mockConstructorTestingTNewFormHandlerFactory interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewFormHandlerFactory(t mockConstructorTestingTNewFormHandlerFactory) *FormHandlerFactory {
