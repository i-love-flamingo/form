...
type mockConstructorTestingTNewCompleteFormService interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewCompleteFormService(t mockConstructorTestingTNewCompleteFormService) *CompleteFormService {
