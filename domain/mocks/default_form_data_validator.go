...
type mockConstructorTestingTNewDefaultFormDataValidator interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewDefaultFormDataValidator(t mockConstructorTestingTNewDefaultFormDataValidator) *DefaultFormDataValidator {
