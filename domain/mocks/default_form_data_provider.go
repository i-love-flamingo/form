...
type mockConstructorTestingTNewDefaultFormDataProvider interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewDefaultFormDataProvider(t mockConstructorTestingTNewDefaultFormDataProvider) *DefaultFormDataProvider {
