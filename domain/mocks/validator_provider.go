...
// ErrorsToValidationInfo provides a mock function for the type ValidatorProvider
func (_mock *ValidatorProvider) ErrorsToValidationInfo(err error) domain.ValidationInfo {
	...
	if returnFunc, ok := ret.Get(0).(func(error) domain.ValidationInfo); ok {
		r0 = returnFunc(err)
	} else {
...
//   - err error
func (_e *ValidatorProvider_Expecter) ErrorsToValidationInfo(err any) *ValidatorProvider_ErrorsToValidationInfo_Call {
...
func (_c *ValidatorProvider_ErrorsToValidationInfo_Call) Return(validationInfo domain.ValidationInfo) *ValidatorProvider_ErrorsToValidationInfo_Call {
	_c.Call.Return(validationInfo)
	return _c
}

func (_c *ValidatorProvider_ErrorsToValidationInfo_Call) RunAndReturn(run func(err error) domain.ValidationInfo) *ValidatorProvider_ErrorsToValidationInfo_Call {
	_c.Call.Return(run)
	return _c
}

// GetValidator provides a mock function for the type ValidatorProvider
func (_mock *ValidatorProvider) GetValidator() *validator.Validate {
	ret := _mock.Called()
...
func (_c *ValidatorProvider_GetValidator_Call) Return(validate *validator.Validate) *ValidatorProvider_GetValidator_Call {
...
// Validate provides a mock function for the type ValidatorProvider
func (_mock *ValidatorProvider) Validate(ctx context.Context, req *web.Request, value interface{}) domain.ValidationInfo {
	ret := _mock.Called(ctx, req, value)
	...
	var r0 domain.ValidationInfo
	if returnFunc, ok := ret.Get(0).(func(context.Context, *web.Request, interface{}) domain.ValidationInfo); ok {
		r0 = returnFunc(ctx, req, value)
	} else {
		r0 = ret.Get(0).(domain.ValidationInfo)
	}
	return r0
...
//   - req *web.Request
//   - value interface{}
func (_e *ValidatorProvider_Expecter) Validate(ctx any, req any, value any) *ValidatorProvider_Validate_Call {
...
func (_c *ValidatorProvider_Validate_Call) Return(validationInfo domain.ValidationInfo) *ValidatorProvider_Validate_Call {
	_c.Call.Return(validationInfo)
	return _c
}

func (_c *ValidatorProvider_Validate_Call) RunAndReturn(run func(ctx context.Context, req *web.Request, value interface{}) domain.ValidationInfo) *ValidatorProvider_Validate_Call {
	_c.Call.Return(run)
	return _c
}
