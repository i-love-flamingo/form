...
type mockConstructorTestingTNewDefaultFormDataEncoder interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewDefaultFormDataEncoder(t mockConstructorTestingTNewDefaultFormDataEncoder) *DefaultFormDataEncoder {
